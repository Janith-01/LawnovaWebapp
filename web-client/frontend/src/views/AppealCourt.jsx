...
export default function AppealCourt() {
    ...
    const fetchDocuments = async (pageNum = page) => {
        setLoadingDocs(true);
        try {
            const res = await axios.get(`${API_BASE}/documents/appeal-court`, {
    ...
    const fetchActiveJob = async () => {
        ...
        try {
            ...
            const runningStatsJob = res.data.find(j =>
                j.job_type === 'CHECK_ONLINE_STATS_CA_DEEP' &&
    ...
    const fetchStats = async () => {
        ...
        try {
            const res = await axios.get(`${API_BASE}/stats/appeal-court`);
            setStats(res.data);
        } catch (e) {
    ...
    const runStatsCheck = async () => {
        ...
        try {
            const res = await axios.post(`${API_BASE}/stats/appeal-court/check`);
    ...
    const startScraper = async () => {
        try {
            ...
            const res = await axios.post(`${API_BASE}/sync/appeal-court`, null, {
                params: { max_pages: 0 }
            });
    ...
    const deleteDocument = async (id) => {
        ...
        try {
            await axios.delete(`${API_BASE}/documents/appeal-court/${id}`);
    ...
    const clearAllDocuments = async () => {
        const confirmText = prompt("Type 'DELETE' to confirm deleting ALL Court of Appeal documents. This cannot be undone.");
        if (confirmText !== 'DELETE') return;

        try {
            const res = await axios.delete(`${API_BASE}/documents/appeal-court`);
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                <h2 className="text-2xl font-bold text-slate-800 mb-2">Court of Appeal Pipeline</h2>
                <p className="text-slate-600 leading-relaxed">
                    This pipeline manages the acquisition and processing of judgments from the Court of Appeal of Sri Lanka website.
                    You can inspect the current collection, manage documents, and execute the scraping process.
                </p>
            </div>
            ...
            <div className="space-y-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500">
                        Monitor the synchronization gap between your local database and the live Court of Appeal archives.
                    </p>
                </div>
                                ...
                                <div className="p-5 flex flex-col h-full relative z-10">
                                    ...
                                    <div className="mt-4 mb-1">
                                        <div className="text-4xl font-bold text-slate-800 tracking-tight flex items-baseline gap-1">
                                            ...
                                            {statsJobId && <span className="text-sm font-normal text-slate-400">found</span>}
                                        </div>
                                    </div>
            ...
            <div className="space-y-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500">
                        Control the background scraping agent. The agent will traverse the Court of Appeal website,
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 h-full flex flex-col space-y-4">
                        ...
                        <div className="text-xs text-slate-400 bg-slate-50 p-3 rounded-lg border border-slate-100">
                            <strong>Note:</strong> Set to scan limited pages by default for stability.
                        </div>
                    </div>
